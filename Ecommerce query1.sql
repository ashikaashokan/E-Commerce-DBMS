...
/*If customer wants to find an order history*/
select product_id,favorite from cart_item where(purchased='yes' and cart_id in (select cart_id from customer where Customer_id='CST004'))
